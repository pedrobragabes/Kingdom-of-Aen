 ...
 * 
 * IMPORTANTE: Este arquivo usa funções GLOBAIS (não ES6 modules)
 * para manter compatibilidade com o carregamento via <script> tags.
 * Arquivos modulares estão em js/modules/ para migração futura.
 */
